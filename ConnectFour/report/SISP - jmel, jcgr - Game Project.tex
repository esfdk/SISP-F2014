...
\titlespacing*{\section}{0pt}{0.5ex}{2.0ex}
...
\pagestyle{fancy}
\lhead{Jakob Melnyk \& Jacob Claudius Grooss}
\chead{Connect 4 game project}
\rhead{SISP 2014}
...
% Title
\title{
\Huge{Connect 4 Game Project}\\
\Large{Intelligent Systems Programming 2014}
}
